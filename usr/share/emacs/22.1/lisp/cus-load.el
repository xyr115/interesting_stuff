...
(put 'mouse 'custom-loads '(artist avoid goto-addr cus-edit mouse mouse-sel mwheel msb strokes tooltip))
...
(put 'multimedia 'custom-loads '(gnus-audio image image-dired mm-decode thumbs))
...
(put 'help 'custom-loads '(apropos cus-edit ehelp help-fns help-at-pt help-mode info info-look man help-macro tooltip tutorial woman))
...
(put 'tools 'custom-loads '(calculator add-log compare-w compile copyright diff diff-mode ebrowse ediff elide-head emerge etags glasses grep gud make-mode pcvs-defs rcompile sieve smerge-mode speedbar tempo tooltip vc which-func))
...
(put 'basic-faces 'custom-loads '(button fringe cus-edit shadowfile tooltip))
...
(put 'gud 'custom-loads '(gdb-ui gud tooltip))
...
(defvar custom-versions-load-alist '(("21.2" mm-util) ("20.3.3" "dos-vars") ("20.1" time-stamp) ("21" printing) ("19.29" time-stamp) ("21.3" sql gnus-agent ange-ftp printing) ("22" ebnf2ps) ("22.0" allout) ("20.3" easymenu dabbrev ffap xscheme rmail paren mailabbrev uce mouse which-func diary-lib sendmail debug msb avoid hexl vcursor vc compile etags browse-url add-log find-func cus-edit) ("21.1" server debug rmailedit ezimage tooltip dabbrev latin1-disp gnus-start hideshow strokes sgml-mode net-utils cperl-mode ange-ftp gnus-nocem paren fortran solar etags rmail sb-image vc-sccs vc gnus-group gnus-sum smtpmail add-log sendmail find-func wid-edit vc-rcs gnus-art nnmail message ps-print vc-cvs cus-edit gnus-agent flyspell rmailsum browse-url) ("20.4" crisp sh-script compile hilit-chg) ("20" ps-print printing ebnf2ps) ("20.8" sql) ("22.1" imenu mm-view cal-tex gnus-score smiley add-log bookmark footnote shadowfile gnus-int view hi-lock gnus-win server tcl descr-text latin1-disp fortran landmark fringe gnus-delay tex-mode sgml-mode gnus-group sql gnus-util mail-extr sh-script hl-line make-mode mml2015 vc-cvs ielm nnimap generic-x imap gnus-soup gnus-start mml-sec comint vc-mcvs desktop locate gnus-msg compare-w info uudecode cal-dst gnus-agent spam find-dired diff-mode ange-ftp mml gnus-fun ispell gnus-spec warnings gnus mouse smtpmail sendmail appt dabbrev dnd pop3 smime time binhex dired rmail mm-url gdb-ui vc-svn mm-decode x-dnd gnus-srvr mm-util vc pgg-def mm-uu autorevert mail-source flow-fill diary-lib iswitchb find-func gnus-art gnus-cite tls nnmail glasses deuglify calendar ffap compile starttls cus-edit gnus-sum grep keypad message))
